...
public class Reserv_goController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("dhdhsdasjkdhsajkldhsajkdhsakjdhsajkdhsjak");
		/*
		 * ClsVO vo = (ClsVO)session.getAttribute("vo");
		 * System.out.println(vo.getCls_idx()); System.out.println(vo.getCls_name());
		 * System.out.println(vo.getCls_price());
		 */
