...
public class ReviewDetailController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * File f = new File(request.getServletContext().getContextPath(), "upload/" +
		 * vo.getReview_image()); System.out.println("path : " + f.getPath());
		 * vo.setReview_image(f.getPath());
		 */
		
		vo.setReview_image(request.getServletContext().getContextPath() + "/upload/"+ vo.getReview_image());
